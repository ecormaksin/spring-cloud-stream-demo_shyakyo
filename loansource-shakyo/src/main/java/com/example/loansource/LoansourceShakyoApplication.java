...
public class LoansourceShakyoApplication {
	
	private static final Logger log = LoggerFactory.getLogger(LoansourceShakyoApplication.class);
	private List<String> names = Arrays.asList("Donald", "Theresa", "Vladimir", "Angela", "Emmanuel", "Shinzō", "Jacinda", "Kim");
	private List<Long> amounts = Arrays.asList(10L, 100L, 1000L, 10000L, 100000L, 1000000L, 10000000L, 100000000L, 1000000000L);

	public static void main(String[] args) {
		SpringApplication.run(LoansourceShakyoApplication.class, args);
